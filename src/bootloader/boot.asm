...
ebr_volume_label:           db 'BRNYOS     '        ; 11 bytes, padded with spaces
...
.after:
    ...
    mov ax, [bdb_sectors_per_fat]   ; calculate root dir size
    shl ax, 5
    xor dx, dx
...
.found_kernel:
    ; di should point to dir entry structure
    mov ax, [di + 26]
...
.load_kernel_loop:
    ...
    ; TODO: fix this awful hardcoded offset
    add ax, 31
